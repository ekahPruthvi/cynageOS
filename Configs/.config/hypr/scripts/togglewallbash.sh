...
if [ $EnableWallDcol -eq 1 ] ; then
    ...
    dunstify $ncolor "theme" -a " Wallbash disabled..." -i "~/.config/dunst/icons/COS.png" -r 91190 -t 2200
else
    sed -i "/^EnableWallDcol/c\EnableWallDcol=1" $TgtScr
    dunstify $ncolor "theme" -a " Wallbash enabled..." -i "~/.config/dunst/icons/COS.png" -r 91190 -t 2200
fi
