...
<p align="center">
    <img align="center" width="49%" src="https://raw.githubusercontent.com/prasanthrangan/hyprdots/main/Source/assets/showcase_1.png" /> 
</p>
...
```shell
pacman -Sy git
git clone https://github.com/ekahPruthvi/hyprdots-SCU.git
cd ~/hyprdots-SCU/Scripts
./install.sh
```
